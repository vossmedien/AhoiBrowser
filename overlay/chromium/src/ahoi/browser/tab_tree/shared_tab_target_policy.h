...
#ifndef AHOI_BROWSER_TAB_TREE_SHARED_TAB_TARGET_POLICY_H_
#define AHOI_BROWSER_TAB_TREE_SHARED_TAB_TARGET_POLICY_H_
...
#endif  // AHOI_BROWSER_TAB_TREE_SHARED_TAB_TARGET_POLICY_H_
