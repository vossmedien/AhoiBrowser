...
| Overlay/patch preflight | `3/3 applies` | The tracked overlay and active series (`0001-ahoi-m152-integration-seams.patch`, `0002-ahoi-deterministic-platform-tests.patch`, `0003-ahoi-upstream-page-load-tracing-test-isolation.patch`) compose non-mutatingly to tree `f93ac99a6918c07b4b39c580ce4354f73bcf5cc9`; see `artifacts/build/chromium-roll-preflight-m152-final.json`. |
