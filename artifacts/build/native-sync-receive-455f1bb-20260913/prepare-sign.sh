...
task_evidence="$task_root/artifacts/build/native-sync-receive-455f1bb-20260913"
...
test "$(plutil -extract AhoiSourceCommit raw "$task_source/Contents/Info.plist")" = 455f1bbf6190f1970d096120e36669b48082af65
test ! -e "$task_app"
