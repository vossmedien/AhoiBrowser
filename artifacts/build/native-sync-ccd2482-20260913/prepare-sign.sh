...
task_evidence="$task_root/artifacts/build/native-sync-ccd2482-20260913"
...
test "$(plutil -extract AhoiSourceCommit raw "$task_source/Contents/Info.plist")" = ccd24827be87ab2cdcc0e2579137eb7d83700b4b
test ! -e "$task_app"
