...
task_evidence='/Volumes/Macintosh HD - Daten/Cloud/Projekte/Apps/Plattformuebergreifend/AhoiBrowser/artifacts/build/native-sync-ccd2482-20260913'
export AHOI_WORK_ROOT='/Volumes/Macintosh HD - Daten/Cloud/Projekte/Apps/Plattformuebergreifend/AhoiBrowser/.work'
export AHOI_JOBS=3
cd "$task_repo" || exit 1
test "$(git rev-parse HEAD)" = ccd24827be87ab2cdcc0e2579137eb7d83700b4b || exit 1
