...
task_evidence="$task_root/artifacts/build/native-sync-e4de9e1-recovery-20260913"
task_source="$task_root/.work/chromium/src/out/AhoiDev/AhoiBrowser.app"
task_app="$task_evidence/cloudkit/AhoiBrowser.app"
task_scope="$task_root/artifacts/e2e/shared-sync-development-scope-20260908.json"
...
test "$(plutil -extract AhoiSourceCommit raw "$task_source/Contents/Info.plist")" = e4de9e14ca3073876e9aa17730876d15cfa41683
test ! -e "$task_app"
