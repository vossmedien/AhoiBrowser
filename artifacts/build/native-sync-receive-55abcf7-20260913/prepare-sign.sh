...
task_evidence="$task_root/artifacts/build/native-sync-receive-55abcf7-20260913"
...
test "$(plutil -extract AhoiSourceCommit raw "$task_source/Contents/Info.plist")" = 55abcf76498dcc8629f94e5ecebde89a4269ecf3
test ! -e "$task_app"
