...
task_evidence="$task_root/artifacts/build/native-sync-26b01b1-20260913"
...
test "$(plutil -extract AhoiSourceCommit raw "$task_source/Contents/Info.plist")" = 26b01b17134a04e6d4e96bf9a837bbcf81ea06e3
test ! -e "$task_app"
