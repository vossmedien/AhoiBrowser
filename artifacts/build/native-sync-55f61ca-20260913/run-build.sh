...
task_evidence='/Volumes/Macintosh HD - Daten/Cloud/Projekte/Apps/Plattformuebergreifend/AhoiBrowser/artifacts/build/native-sync-55f61ca-20260913'
...
cd "$task_repo" || exit 1
test "$(git rev-parse HEAD)" = 55f61cae5b7c397860a6fe175065f3d97cd7097d || exit 1
