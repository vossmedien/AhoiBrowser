...
task_evidence="$task_root/artifacts/build/native-sync-55f61ca-20260913"
...
test "$(plutil -extract AhoiSourceCommit raw "$task_source/Contents/Info.plist")" = 55f61cae5b7c397860a6fe175065f3d97cd7097d
test ! -e "$task_app"
