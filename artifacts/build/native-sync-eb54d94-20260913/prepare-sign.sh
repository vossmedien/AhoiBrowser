...
task_evidence="$task_root/artifacts/build/native-sync-eb54d94-20260913"
...
test "$(plutil -extract AhoiSourceCommit raw "$task_source/Contents/Info.plist")" = eb54d94ac61d04ae88d1b4bd284d3db5f4723ef6
test ! -e "$task_app"
