...
task_evidence='/Volumes/Macintosh HD - Daten/Cloud/Projekte/Apps/Plattformuebergreifend/AhoiBrowser/artifacts/build/native-unified-108e91a-20260919'
...
cd "$task_repo" || exit 1
test "$(git rev-parse HEAD)" = 108e91aea7bae43542885d54fce8b35a9a92d232 || exit 1
