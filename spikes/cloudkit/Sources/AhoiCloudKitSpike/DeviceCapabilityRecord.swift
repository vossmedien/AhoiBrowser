...
/// A current-format declaration tied to a separately authenticated DeviceRecord.
...
public struct DeviceCapabilityRecord: Codable, Hashable, Sendable, Identifiable {
    ...
    public init(
        id: UUID? = nil, deviceID: DeviceID,
        readableModels: [UInt32] = [SharedSyncFormat.currentVersion],
        writableModels: [UInt32] = [SharedSyncFormat.currentVersion],
    ...
    public func validate() throws {
        ...
        guard readableModels == [SharedSyncFormat.currentVersion],
              writableModels == [SharedSyncFormat.currentVersion] else {
