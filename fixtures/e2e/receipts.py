...
KNOWN_PATHS = frozenset(
    {
        ...
        "/download-upload",
        "/download/disconnect-once.zip",
        "/download/deterministic.bin",
        "/download/harmless-warning.exe",
        "/download/large-range.zip",
        "/failure/recover-once",
        "/failure/subframe-404",
        "/failure/subframe-500",
        "/headers/echo",
        "/injection",
        "/login",
        "/media",
        ...
        "/privacy",
        "/privacy/echo",
        "/privacy/marker/clear",
        "/privacy/marker/inspect",
        "/privacy/marker/set",
        "/redirect/cross",
        "/redirect/dns-failure",
        "/redirect/same",
        "/service-worker.js",
        "/split",
        "/slow-document",
